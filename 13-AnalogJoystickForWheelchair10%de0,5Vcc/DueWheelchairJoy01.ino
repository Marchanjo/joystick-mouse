//In (joystick) (0 a 1023) e out (1843 a 2252) metade de 4095 = 2047 sendo que 1843(-10% da metade de Vcc) e 2252(+10% da metade de Vcc) padrão para joystick de cadeira de rodas
int led = 13;
...
int convertionADtoDA(int joy)
  {
   ...
   // testar: out=1638+(in*0.8);//joy (0 a 1023) e out (1638 a 2457) metade de 4095 = 2047 sendo que 1638(-10% de vcc) e 2457(+10% vcc) padrão para joystick de cadeira de rodas
   return (int) out;    
  }
