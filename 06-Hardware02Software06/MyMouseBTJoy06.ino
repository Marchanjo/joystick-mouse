...
//Botão 2 mais fácil de acionar assimétrico, com limiar em 600 ao invés de 800
...
//horizontal2=-horizontal2;   
  ...
  if((horizontal2>600)&&(button2==false)) {button2=true;mouseRefresh=true;}//manda a informação de botão acionado uma vez Botão 2 mais fácil de acionar assimétrico, com limiar em 600 ao invés de 800
  ...
  if((horizontal2<=600)&&(button2==true)) {button2=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez Botão 2 mais fácil de acionar assimétrico, com limiar em 600 ao invés de 800
