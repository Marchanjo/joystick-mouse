...
//o outro com botão2(esq) botão1(dir) Cursor up (cima) Cursor down (baixo) diagonal (up-right) com clicklock}
...
//horizontal2=-horizontal2;   
  ...
  //if((horizontal2>800)&&(vertical2>224)&&(vertical2<800)&&(button2==false)) {button2=true;mouseRefresh=true;}//left //digitalWrite(blueLed, HIGH);digitalWrite(redLed, LOW );digitalWrite(greenLed, LOW);
  //if((horizontal2>=224)&&(horizontal2<=800)&&(button2==true)&&(vertical2>=224)&&(vertical2<=800)) {button2=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez
  
  //a if((horizontal2>620)&&(vertical2>224)&&(vertical2<800)&&(button2==false)) {button2=true;mouseRefresh=true;}//left //digitalWrite(blueLed, HIGH);digitalWrite(redLed, LOW );digitalWrite(greenLed, LOW);
  //a if((horizontal2>=228)&&(horizontal2<=616)&&(button2==true)&&(vertical2>=228)&&(vertical2<=796)) {button2=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez


  //a if((horizontal2<224)&&(vertical2>224)&&(vertical2<800)&&(button1==false)) {button1=true;mouseRefresh=true;}//right //digitalWrite(redLed, HIGH);digitalWrite(greenLed, LOW );digitalWrite(blueLed, LOW);
  //a if((horizontal2>=228)&&(horizontal2<=616)&&(button1==true)&&(vertical2>=228)&&(vertical2<=796)&&(button1ClickLock==false)) {button1=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez
  
  
  // Cursor Up
  if((horizontal2>424)&&(horizontal2<600)&&(vertical2>800)) {Serial.write(0x80);delay(40);}//up //digitalWrite(greenLed, HIGH );digitalWrite(redLed, LOW);digitalWrite(blueLed, LOW);
  
  // Cursor Down
  if((horizontal2>424)&&(horizontal2<600)&&(vertical2<224)) {Serial.write(0x82);delay(40);}//down //digitalWrite(redLed, HIGH);digitalWrite(blueLed, HIGH );digitalWrite(greenLed, LOW);
  ...
  //Click Botão 2  
  if((horizontal2>600)&&(vertical2>424)&&(vertical2<600)&&(button2==false)) {button2=true;mouseRefresh=true;}//left //digitalWrite(blueLed, HIGH);digitalWrite(redLed, LOW );digitalWrite(greenLed, LOW);
  ...
  if((horizontal2>800)&&(button2==false)&&(vertical2>200)&&(vertical2<800)) {button2=true;mouseRefresh=true;}//left botão2 manda a informação de botão acionado uma vez
  if((horizontal2<200)&&(button1==false)&&(vertical2>200)&&(vertical2<800)) {button1=true;mouseRefresh=true;}//right botao1 manda a informação de botão acionado uma vez
  //botão aberto
  //if((digitalRead(SEL)==1)&&(button1==true)) {button1=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez
  if((horizontal2<=800)&&(button2==true)&&(vertical2>200)&&(vertical2<800)) {button2=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez
  if((horizontal2>=200)&&(button1==true)&&(vertical2>200)&&(vertical2<800)) {button1=false;mouseRefresh=true;}//manda a informação de botão levantado uma vez
  */
  ...
  //if(vertical2>800){Serial.write(0x80);delay(40);}//cursor up
  //if(vertical2<200){Serial.write(0x82);delay(40);}//cursor down
